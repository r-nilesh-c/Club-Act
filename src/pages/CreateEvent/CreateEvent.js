      ...
      <div className="create-event-container">
        <form onSubmit={handleSubmit} className="create-event-form">
          ...
          <div className="form-section">
            ...
            {formData.participation_type === 'group' && formData.price && formData.max_team_size && (
              <div className="team-pricing-info">
                <p>
                  <strong>Team Pricing:</strong> Each member pays {formData.price}
                </p>
                <p>
                  <strong>Total for max team:</strong> {formData.price} × {formData.max_team_size} members = {formData.price.replace(/[^0-9]/g, '') * formData.max_team_size || 'N/A'}
                </p>
              </div>
            )}
          </div>
